...
# :heavy_check_mark: test/data_structures/lazy_segment_tree.sum_add.test.cpp
...
#line 6 "test/data_structures/lazy_segment_tree.sum_add.test.cpp"

#line 8 "test/data_structures/lazy_segment_tree.sum_add.test.cpp"
using namespace std;
using ll = long long;
using P = pair<ll, int>;
